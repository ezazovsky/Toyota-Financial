...
export default function FinanceCalculator({ vehiclePrice, onCalculationChange }: FinanceCalculatorProps) {
  ...
  const calculatePayments = () => {
    ...
    if (financeType === 'finance') {
      ...
      // Lease calculation - use the detailed calculation
      ...
      totalCost = leaseDetails.totalOfPayments + downPayment // Total of lease payments plus down payment
      totalInterest = leaseDetails.totalFinanceCharges // This is finance charges, not traditional interest
    }
